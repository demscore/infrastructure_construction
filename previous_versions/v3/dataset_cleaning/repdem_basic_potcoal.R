...
# no_duplicates(repdem_basic_potcoal, c("cab_id", "potential_coalition")) #TRUE
...
repdem_basic_potcoal$u_repdem_cabinet_pot_coal_coalition <- 
  repdem_basic_potcoal$potential_coalition
...
#write_file(repdem_basic_potcoal,
#           file.path(Sys.getenv("ROOT_DIR"),
#                     "datasets/repdem/cleaned_datasets_dta/repdem_basic_potcoal_cleaned.dta"),
#           overwrite = TRUE)

#write_file(repdem_basic_potcoal,
#           file.path(Sys.getenv("ROOT_DIR"),
#                     "datasets/repdem/cleaned_datasets_csv/repdem_basic_potcoal_cleaned.csv"),
#           overwrite = TRUE)