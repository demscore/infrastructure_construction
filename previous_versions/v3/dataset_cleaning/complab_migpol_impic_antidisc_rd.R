...
write_file(complab_migpol_impic_antidisc_rd,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/complab/cleaned_datasets_dta/complab_migpol_impic_antidisc_rd_cleaned.dta"),
           overwrite = TRUE)

write_file(complab_migpol_impic_antidisc_rd,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/complab/cleaned_datasets_csv/complab_migpol_impic_antidisc_rd_cleaned.csv"),
           overwrite = TRUE)