...
write_file(repdem_wecee_year,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/repdem/cleaned_datasets_dta/repdem_wecee_year_cleaned.dta"),
           overwrite = TRUE)

write_file(repdem_wecee_year,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/repdem/cleaned_datasets_csv/repdem_wecee_year_cleaned.csv"),
           overwrite = TRUE)