...
write_file(views_pgm_11_23,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/ucdp/cleaned_datasets_dta/views_pgm_11_23_cleaned.dta"),
           overwrite = TRUE)

write_file(views_pgm_11_23,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/ucdp/cleaned_datasets_csv/views_pgm_11_23_cleaned.csv"),
           overwrite = TRUE)
