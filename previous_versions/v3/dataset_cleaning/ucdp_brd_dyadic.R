...
write_file(ucdp_brd_dyadic,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/ucdp/cleaned_datasets_dta/ucdp_brd_dyadic_cleaned.dta"),
           overwrite = TRUE)

write_file(ucdp_brd_dyadic,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/ucdp/cleaned_datasets_csv/ucdp_brd_dyadic_cleaned.csv"),
           overwrite = TRUE)