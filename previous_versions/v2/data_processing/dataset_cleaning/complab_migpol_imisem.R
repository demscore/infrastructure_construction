...
write_file(complab_migpol_imisem,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/complab/cleaned_datasets_dta/complab_migpol_imisem_cleaned.dta"),
           overwrite = TRUE)

write_file(complab_migpol_imisem,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/complab/cleaned_datasets_csv/complab_migpol_imisem_cleaned.csv"),
           overwrite = TRUE)
