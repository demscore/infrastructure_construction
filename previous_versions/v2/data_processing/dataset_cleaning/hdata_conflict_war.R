...
write_file(hdata_conflict_war,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/hdata/cleaned_datasets_dta/hdata_conflict_war_cleaned.dta"),
           overwrite = TRUE)

write_file(hdata_conflict_war,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/hdata/cleaned_datasets_csv/hdata_conflict_war_cleaned.csv"),
           overwrite = TRUE)