...
write_file(complab_spin_sied,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/complab/cleaned_datasets_dta/complab_spin_sied_cleaned.dta"),
           overwrite = TRUE)

write_file(complab_spin_sied,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/complab/cleaned_datasets_csv/complab_spin_sied_cleaned.csv"),
           overwrite = TRUE)