...
write_file(complab_migpol_gc_acq,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/complab/cleaned_datasets_dta/complab_migpol_gc_acq_cleaned.dta"),
           overwrite = TRUE)

write_file(complab_migpol_gc_acq,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/complab/cleaned_datasets_csv/complab_migpol_gc_acq_cleaned.csv"),
           overwrite = TRUE)