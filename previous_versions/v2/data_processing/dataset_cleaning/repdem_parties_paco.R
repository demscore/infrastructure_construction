...
write_file(repdem_parties_paco,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/repdem/cleaned_datasets_dta/repdem_parties_paco_cleaned.dta"),
           overwrite = TRUE)

write_file(repdem_parties_paco,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/repdem/cleaned_datasets_csv/repdem_parties_paco_cleaned.csv"),
           overwrite = TRUE)
