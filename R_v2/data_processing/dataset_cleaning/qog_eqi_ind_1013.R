...
write_file(qog_eqi_ind_1013,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/qog/cleaned_datasets_dta/qog_eqi_ind_1013_cleaned.dta"),
           overwrite = TRUE)

write_file(qog_eqi_ind_1013,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/qog/cleaned_datasets_csv/qog_eqi_ind_1013_cleaned.csv"),
           overwrite = TRUE)