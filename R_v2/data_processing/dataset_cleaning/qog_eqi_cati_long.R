...
write_file(qog_eqi_cati_long,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/qog/cleaned_datasets_dta/qog_eqi_cati_long_cleaned.dta"),
           overwrite = TRUE)

write_file(qog_eqi_cati_long,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/qog/cleaned_datasets_csv/qog_eqi_cati_long_cleaned.csv"),
           overwrite = TRUE)