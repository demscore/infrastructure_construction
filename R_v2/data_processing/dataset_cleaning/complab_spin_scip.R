...
complab_spin_scip %<>% select(-country_nr, -country_code, -u_complab_country_year_country_nr)
...
write_file(complab_spin_scip,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/complab/cleaned_datasets_dta/complab_spin_scip_cleaned.dta"),
           overwrite = TRUE)

write_file(complab_spin_scip,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/complab/cleaned_datasets_csv/complab_spin_scip_cleaned.csv"),
           overwrite = TRUE)