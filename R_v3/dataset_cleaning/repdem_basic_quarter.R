...
write_file(repdem_basic_quarter,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/repdem/cleaned_datasets_dta/repdem_basic_quarter_cleaned.dta"),
           overwrite = TRUE)

write_file(repdem_basic_quarter,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/repdem/cleaned_datasets_csv/repdem_basic_quarter_cleaned.csv"),
           overwrite = TRUE)