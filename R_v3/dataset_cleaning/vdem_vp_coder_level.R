...
write_file(vdem_vp_coder_level,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/vdem/cleaned_datasets_dta/vdem_vp_coder_level_cleaned.dta"),
           overwrite = TRUE)

write_file(vdem_vp_coder_level,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/vdem/cleaned_datasets_csv/vdem_vp_coder_level_cleaned.csv"),
           overwrite = TRUE)