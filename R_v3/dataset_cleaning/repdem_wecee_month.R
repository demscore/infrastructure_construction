...
write_file(repdem_wecee_month,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/repdem/cleaned_datasets_dta/repdem_wecee_month_cleaned.dta"),
           overwrite = TRUE)

write_file(repdem_wecee_month,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/repdem/cleaned_datasets_csv/repdem_wecee_month_cleaned.csv"),
           overwrite = TRUE)