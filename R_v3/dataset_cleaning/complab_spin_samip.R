...
write_file(complab_spin_samip,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/complab/cleaned_datasets_dta/complab_spin_samip_cleaned.dta"),
           overwrite = TRUE)

write_file(complab_spin_samip,
           file.path(Sys.getenv("ROOT_DIR"),
                     "datasets/complab/cleaned_datasets_csv/complab_spin_samip_cleaned.csv"),
           overwrite = TRUE)
