...
# Filter out rows with missing values in key columns from repdem_wecee_party
repdem_wecee_party <- repdem_wecee_party %>%
  filter(!is.na(u_repdem_cabinet_party_partycode),
         !is.na(u_repdem_cabinet_party_year),
         !is.na(u_repdem_cabinet_party_country))
