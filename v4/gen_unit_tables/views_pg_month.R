...
views_pgm_02_24 <- read_datasets("views_pgm_02_24", db)
views_pgm_03_24 <- read_datasets("views_pgm_03_24", db)
views_pgm_04_24 <- read_datasets("views_pgm_04_24", db)
views_pgm_05_24 <- read_datasets("views_pgm_05_24", db)
views_pgm_06_24 <- read_datasets("views_pgm_06_24", db)
views_pgm_07_24 <- read_datasets("views_pgm_07_24", db)
...
u_views_pg_month <- 
  bind_rows(
    ...
    select(views_pgm_01_24, 
           u_views_pg_month_pg_id,
           u_views_pg_month_month_id),
    select(views_pgm_02_24, 
           u_views_pg_month_pg_id,
           u_views_pg_month_month_id),
    select(views_pgm_03_24, 
           u_views_pg_month_pg_id,
           u_views_pg_month_month_id),
    select(views_pgm_04_24, 
           u_views_pg_month_pg_id,
           u_views_pg_month_month_id),
    select(views_pgm_05_24, 
           u_views_pg_month_pg_id,
           u_views_pg_month_month_id),
    select(views_pgm_06_24, 
           u_views_pg_month_pg_id,
           u_views_pg_month_month_id),
    select(views_pgm_07_24, 
           u_views_pg_month_pg_id,
           u_views_pg_month_month_id),
  ) %>%
  distinct(.) %>%
