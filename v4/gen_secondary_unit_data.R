...
for (i in 1:nrow(utrans)) {
	...
	# combination.
	if (ds$tag == "qog_eqi_cati_long" & utranssub$finish == "u_ucdp_conflict_location_year"|
	    ds$tag == "qog_exp" & utranssub$finish == "u_ucdp_orgv_country_year"|
	    ...
	    ds$tag == "complab_spin_cbd" & utranssub$finish == "u_ucdp_par_event"|
	    ds$tag == "complab_spin_plb" & utranssub$finish == "u_qog_country"|
	    ds$tag == "complab_spin_plb" & utranssub$finish == "u_qog_region"|
	    ds$tag == "complab_spin_plb" & utranssub$finish == "u_ucdp_par_event"|
	    ...
	    ds$tag == "complab_spin_outwb" & utranssub$finish == "u_ucdp_par_event"|
	    ...
	    ds$tag == "complab_grace" & utranssub$finish == "u_ucdp_par_event"|
	    ...
	    ds$tag == "complab_spin_hben" & utranssub$finish == "u_ucdp_par_event"|
	    ...
	    ds$tag == "complab_spin_samip" & utranssub$finish == "u_ucdp_par_event"|
	    ds$tag == "complab_migpol_imisem" & utranssub$finish == "u_ucdp_par_event"|
	    ds$tag == "complab_migpol_impic" & utranssub$finish == "u_ucdp_par_event"|
	    ...
	    ds$tag == "complab_migpol_impic_antidisc" & utranssub$finish == "u_ucdp_par_event"|
	    ...
	    ds$tag == "complab_migpol_impic_antidisc_rd" & utranssub$finish == "u_ucdp_par_event"|
	    ...
	    ds$tag == "complab_migpol_mipex" & utranssub$finish == "u_ucdp_par_event"|
	    ds$tag == "complab_spin_scip" & utranssub$finish == "u_qog_country"|
	    ds$tag == "complab_spin_scip" & utranssub$finish == "u_ucdp_par_event"|
	    ...
	    ds$tag == "complab_spin_sied" & utranssub$finish == "u_ucdp_par_event"|
	    ds$tag == "complab_spin_ssfd" & utranssub$finish == "u_ucdp_par_event"|
	    ...
	    ds$tag == "complab_spin_ssd" & utranssub$finish == "u_ucdp_par_event"|
	    ...
	    ds$tag == "complab_migpol_hip" & utranssub$finish == "u_qog_region"|
	    ds$tag == "complab_migpol_hip" & utranssub$finish == "u_ucdp_par_event"|
	    ##
	    ...
	    ds$tag == "ucdp_nscia" & utranssub$finish == "u_ucdp_par_event"|
	    ds$tag == "ucdp_dyadic" & utranssub$finish == "u_ucdp_par_event"|
	    ds$tag == "ucdp_vpp" & utranssub$finish == "u_ucdp_par_event"|
	    ds$tag == "ucdp_brd_dyadic" & utranssub$finish == "u_ucdp_par_event"|
	    ds$tag == "ucdp_onesided" & utranssub$finish == "u_ucdp_par_event"|
	    ds$tag == "ucdp_esd_dy" & utranssub$finish == "u_ucdp_par_event"|
	    ds$tag == "ucdp_term_dyadic" & utranssub$finish == "u_ucdp_par_event"|
	    ds$tag == "ucdp_extsupp" & utranssub$finish == "u_ucdp_par_event"|
	    ds$tag == "ucdp_cid_dy" & utranssub$finish == "u_ucdp_par_event"|
	    ds$tag == "ucdp_nonstate" & utranssub$finish == "u_ucdp_pa_conflict_year"|
	    ##
	    ...
	    ds$tag == "hdata_conflict_cy" & utranssub$finish == "u_ucdp_par_event"|
	    ##
	    ds$tag == "hdata_conflict_cy" & utranssub$finish == "u_cses_respondent"
