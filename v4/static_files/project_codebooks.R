...
args <- list(help = FALSE,
             ...
             file_format = "CSV",
             outfile = paste0("~/data/demscore_next_release/zip/project_codebooks/qog_codebook.pdf"),
             project = "qog")
...
for (i in projects) {
  ...
  args <- list(help = FALSE,
               include_unit_cols = TRUE, 
               file_format = "CSV",
               outfile = paste0("~/data/demscore_next_release/zip/project_codebooks/", i, "_codebook.pdf"),
               project = i)
