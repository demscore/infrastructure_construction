...
repdem_paco_quarter <- read_datasets("repdem_paco_quarter", db) 
repdem_pastr_quarter <- read_datasets("repdem_pastr_quarter", db)

# Bind rows
u_repdem_cabinet_quarter <- 
  bind_rows(select(repdem_paco_quarter, 
                   u_repdem_cabinet_quarter_cab_name, 
                   u_repdem_cabinet_quarter_quarter,
                   u_repdem_cabinet_quarter_country), 
            select(repdem_pastr_quarter, 
                   u_repdem_cabinet_quarter_cab_name, 
                   u_repdem_cabinet_quarter_quarter,
                   u_repdem_cabinet_quarter_country), 
  )%>%
