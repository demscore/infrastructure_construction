...
cb <- left_join(codebook, variables, by = c("codebook_id")) %>%
  ...
  filter(!grepl("^qog_oecd_|^qog_std_cs|^vdem_cd|^vdem_coder|^qog_eureg_wide|^vdem_vparty_coder|ucdp_|repdem_paged_paco|repdem_paco|repdem_pastr|country", tag_long)) %>%
